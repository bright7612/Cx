...
//        $attr['class']='btn btn-info';
    ...
    {
        return $this->button(L('_CLEAR_OUT_'), array('class' => 'btn ajax-post btn-danger', 'data-confirm' => L('_CONFIRM_CLEAR_OUT_'), 'url' => U('', array('model' => $model)), 'target-form' => 'ids', 'hide-data' => 'true'));
    }
