...
function tinyImgUpload(ele, options) {
    ...
    if(eleList.length == 0){
        ...
        eleList[0].innerHTML ='<div id="img-container" >'+
                '<div class="img-up-add  img-item"> <span class="img-add-icon iconfont icon-tianjiajiahaowubiankuang"></span><span class="tj">添加图片<span> </div>'+
                ...
                reader.onload = (function (theFile) {
                    return function (e) {
                        ...
                        oDiv.innerHTML = '<img class="thumb-icon" src="'+e.target.result+'" />'+
                            ...
                            '<input type="hidden" name="files" class="files" value="'+e.target.result+'">'*/
