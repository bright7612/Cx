...
function ButtonStartRealplayByWndNo_onclick(tdid) {
    var obj = document.getElementById("DPSDK_OCX");
...
function ButtonStartTimePlaybackByWndNo_onclick(tdid, stratTime, endTime) {
    var obj = document.getElementById("DPSDK_OCX");
    ...
    ShowCallRetInfo(obj.DPSDK_StartTimePlaybackByWndNo(gWndId, nWndNo, szCameraId, nRecordSource, stratTime, endTime), "按时间回放");
}
