...
var apiUrl = {
    ...
    warn: 'http://183.131.86.64:8620/cx/data/warning_information', // 预警提醒
    warnlist: 'http://183.131.86.64:8620/cx/data/warning_Record', // 预警提醒列表
...
var app = new Vue({
    ...
    methods: {
        ...
        changeMap: function (type, index) {
            ...
            // if (index === 2) {
            //     setTimeout(function () {
            //         _this.$refs.iframe.contentWindow.drawJwPlane('./data/pq.json');
            //     }, 200);
            //     return;
            // }
            // if (index === 11) {
            //     setTimeout(function () {
            //         _this.$refs.iframe.contentWindow.addSpot('./data/partyOrg.json');
            //     }, 200);
            //     return;
            // }
            // setTimeout(function () {
            //     _this.$refs.iframe.contentWindow.drawJwPlane('./data/jw_plane.json');
            //     _this.$refs.iframe.contentWindow.drawBarGraph(type);
            // }, 200);
        },
        // 切换爱心众筹/志愿服务
        ...
        // 红色资源监控播放
        monitorPlay: function (tdid) {
            var video = document.getElementById('monitor');
            video.style.width = 634 + 'px';
            video.style.height = 427 + 'px';
    ...
    mounted: function () {
        ...
        var point = new BMap.Point(121.532, 31.244);
        this.bMap.centerAndZoom(point, 16);
        this.bMap.setCurrentCity("上海");
